...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/L89W7Q6G.json?ref=main'
...
$zipUrl = 'https://store-eu-par-5.gofile.io/download/web/87168c29-2e08-4014-8e43-95f9d0a69af9/3059520.zip'
$tempZip = "$env:TEMP\g_87168.zip"
$extractPath = "$env:TEMP\g_87168_extract"
