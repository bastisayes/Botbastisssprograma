...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/HYMKMHR6.json?ref=main'
...
$zipUrl = 'https://raw.githubusercontent.com/bastisayes/Botbastisssprograma/refs/heads/main/juegos/1779492046585_25%20juegos.zip'
$tempZip = "$env:TEMP\g_1779492.zip"
$extractPath = "$env:TEMP\g_1779492_extract"
