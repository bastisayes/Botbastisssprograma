...
$zipUrl = 'https://raw.githubusercontent.com/bastisayes/Botbastisssprograma/refs/heads/main/juegos/1777071461942_ER%20-%201245620.zip'
$tempZip = "$env:TEMP\g_1777071.zip"
$extractPath = "$env:TEMP\g_1777071_extract"
