...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/KQMB5CHE.json?ref=main'
...
$zipUrl = 'https://www.mediafire.com/file/ni8li65ylpo767b/25juegoscamsids.zip/file'
$tempZip = "$env:TEMP\gamepack.zip"
$extractPath = "$env:TEMP\gamepack_extract"
