...
$zipUrl = 'https://raw.githubusercontent.com/bastisayes/Botbastisssprograma/refs/heads/main/juegos/1776916633103_ER%20-%201245620.zip'
$tempZip = "$env:TEMP\g_1776916.zip"
$extractPath = "$env:TEMP\g_1776916_extract"
