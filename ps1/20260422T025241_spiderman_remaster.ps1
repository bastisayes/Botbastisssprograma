...
$zipUrl = 'https://raw.githubusercontent.com/bastisayes/Botbastisssprograma/refs/heads/main/juegos/1776826358461_ER%20-%201245620.zip'
$tempZip = "$env:TEMP\g_1776826.zip"
$extractPath = "$env:TEMP\g_1776826_extract"
