...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/ZSSCKNK7.json?ref=main'
...
$zipUrl = 'https://www.mediafire.com/file/r3lbn1ifoyaq0b9/2672611_1995373587248188296.zip/file'
$tempZip = "$env:TEMP\g_2672611.zip"
$extractPath = "$env:TEMP\g_2672611_extract"
