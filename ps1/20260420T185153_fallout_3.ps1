...
$zipUrl = 'https://raw.githubusercontent.com/bastisayes/Botbastisssprograma/refs/heads/main/juegos/1776711110278_Fallout%203%20-%2022370.zip'
$tempZip = "$env:TEMP\g_1776711.zip"
$extractPath = "$env:TEMP\g_1776711_extract"
