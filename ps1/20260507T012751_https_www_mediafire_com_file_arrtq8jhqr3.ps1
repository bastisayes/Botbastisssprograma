...
$statusUrl = 'https://api.github.com/repos/bastisayes/Botbastisssprograma/contents/subirj_status/7LSSV7XH.json?ref=main'
...
$zipUrl = 'https://www.mediafire.com/file/arrtq8jhqr35sca/5_juegosss.zip/file'
